...
for ( x = 0 ; x < 16 ; x++ ) {
	...
	imArray[x].src = "../img/entropipes/" + tileNames[x] + ".png";
}
...
function writePlantilla() {
	...
	for ( y = 0 ; y < H ; y++ ) {
		table += "<tr>";
		for ( x = 0 ; x < W ; x++ ) {
			table += '<td><img id="c'+(casilla++)+'" src="../img/entropipes/0.png" onClick="setCasilla(this);return true;"></td>';
		}
		table += "</tr>";
    }
...
function viewPlantilla() {
	...
	for ( x = 0 ; x < W*H ; x++ ) {
		...
		casilla.src="../img/entropipes/" + aPlantilla[x] + ".png";
    }
